...
def build():
    buildAll()
    return "<h1>Database is built</h1>"
...
def addStudent():
    if request.method=="POST":
        ...
        thisStudent = Student.add(studentID, fname, lname, address, email)
        flash(f"Student {fname} {lname} has been added as record {thisStudent.id}")
...
class Section(db.Model):
    ...
    def build(cls, log=False):
        # Used for building EXAMPLE data only DO NOT use for production
        SADTProgramID = 1
        cls.add("23-3-A", datetime.datetime(2023, 9, 5), datetime.datetime(2023, 12, 15), SADTProgramID, log=log)
        cls.add("23-3-B", datetime.datetime(2023, 9, 5), datetime.datetime(2023, 12, 15), SADTProgramID, log=log)
        cls.add("23-3-C", datetime.datetime(2023, 9, 5), datetime.datetime(2023, 12, 15), SADTProgramID, log=log)
        cls.add("23-3-D", datetime.datetime(2023, 9, 5), datetime.datetime(2023, 12, 15), SADTProgramID, log=log)
        return
